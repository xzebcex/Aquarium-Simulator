...
NUM_KELP = 6  # (!) Try changing this values.
NUM_FISH = 10  # (!) Try changing this values.
NUM_BUBBLERS = 3  # (!) Try changing this values.
FRAMES_PER_SECOND = 12  # (!) Try changing this values.
